...
function generateJokeLine( joke ){
    ...
    */
    ...
    tdIDHTML.innerText = joke.id;

    // Catégorie
    let tdCategoryHTML = document.createElement('TD');
    tdCategoryHTML.innerText = joke.category;

    // Type
    let tdTypeHTML = document.createElement('TD');
    tdTypeHTML.innerText = joke.type;
    ...
    // Filiation de tous les TD au TR
        ...
        generatedJokeLine.appendChild(tdIDHTML);
        generatedJokeLine.appendChild(tdCategoryHTML);
        generatedJokeLine.appendChild(tdTypeHTML);
